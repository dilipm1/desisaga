products = [
  ...
  # === Regional Sankranti / Pongal variants (solar 270° — same transit, different hamper) ===
  {
    ...
    category: "Sankranti",
    region: "tamil-nadu",
    images: ["/images/regions/thai-pongal-harvest.jpg"],
    in_stock: true,
    featured: true,
  ...
  },
  {
    ...
    category: "Sankranti",
    region: "gujarat",
    images: ["/images/regions/uttarayan-kite-hamper.jpg"],
    in_stock: true,
    featured: false,
  ...
  },
  {
    ...
    category: "Sankranti",
    region: "punjab",
    images: ["/images/regions/maghi-lohri-hamper.jpg"],
    in_stock: true,
    featured: false,
  ...
  },
  {
    ...
    category: "Sankranti",
    region: "karnataka",
    images: ["/images/regions/sankranti-ellu-bella-karnataka.jpg"],
    in_stock: true,
    featured: false,
  ...
  },
  {
    ...
    images: ["/images/regions/sankranti-bhogi-andhra.jpg"],
    in_stock: true,
    featured: true,
  ...
  },
  {
    ...
    category: "Sankranti",
    region: "telangana",
    images: ["/images/regions/sankranti-kanuma-telangana.jpg"],
    in_stock: true,
    featured: true,
  ...
  # === Ugadi / Yugadi / Gudi Padwa variants (Chaitra Shukla Pratipada) ===
  {
    ...
    category: "Ugadi",
    region: "karnataka",
    images: ["/images/regions/yugadi-pachadi-karnataka.jpg"],
    in_stock: true,
    featured: false,
  ...
  },
  {
    ...
    category: "Ugadi",
    region: "maharashtra",
    images: ["/images/regions/gudi-padwa-maharashtra.jpg"],
    in_stock: true,
    featured: true,
  ...
  # === Vaisakhi / Solar New Year variants (Mesha Sankranti Apr 14) ===
  {
    ...
    category: "Vaisakhi",
    region: "punjab",
    images: ["/images/regions/vaisakhi-punjab-harvest.jpg"],
    in_stock: true,
    featured: true,
  ...
  },
  {
    ...
    category: "Vaisakhi",
    region: "tamil-nadu",
    images: ["/images/regions/puthandu-tamil-new-year.jpg"],
    in_stock: true,
    featured: false,
  ...
  },
  {
    ...
    category: "Vaisakhi",
    region: "kerala",
    images: ["/images/regions/vishu-kerala-kani.jpg"],
    in_stock: true,
    featured: false,
  ...
  },
  {
    ...
    region: "bihar",
    images: ["/images/regions/chhath-puja-bihar.jpg"],
    in_stock: true,
    featured: false,
